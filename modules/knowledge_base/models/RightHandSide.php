...
/**
 * This is the model class for table "{{%right_hand_side}}".
 *
 * @property integer $id
 ...
 */
class RightHandSide extends \yii\db\ActiveRecord
{
    /**
    ...
    {
        return [
            'id' => Yii::t('app', 'RIGHT_HAND_SIDE_MODEL_ID'),
            'created_at' => Yii::t('app', 'RIGHT_HAND_SIDE_MODEL_CREATED_AT'),
            'updated_at' => Yii::t('app', 'RIGHT_HAND_SIDE_MODEL_UPDATED_AT'),
            'ontology_class' => Yii::t('app', 'RIGHT_HAND_SIDE_MODEL_ONTOLOGY_CLASS'),
            'relationship' => Yii::t('app', 'RIGHT_HAND_SIDE_MODEL_RELATIONSHIP'),
        ];
    }
