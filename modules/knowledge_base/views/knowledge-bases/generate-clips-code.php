...
$this->title = Yii::t('app', 'KNOWLEDGE_BASES_PAGE_GENERATE_CLIPS_CODE');
...
<div class="generate-clips-code">
    ...
    <div >
        <?php echo Alert::widget([
            ...
            'body' => Yii::t('app', 'KNOWLEDGE_BASE_MODEL_SELECT_SOFTWARE_COMPONENT_FOR_GENERATE_CLIPS_CODE'),
        ]); ?>
    </div>
            ...
            [
                ...
                'buttons' => [
                    ...
                    'select' => function ($url, $software_component, $key) use ($model) {
                        $url = Url::toRoute('/knowledge-bases/export-knowledge-base/' . $model->id . '/' . $key);
                        return Html::a(
