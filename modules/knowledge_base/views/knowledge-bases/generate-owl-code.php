...
$this->title = Yii::t('app', 'KNOWLEDGE_BASES_PAGE_GENERATE_OWL_CODE');
...
<div class="generate-owl-code">
    ...
    <div >
        <?php echo Alert::widget([
            ...
            'body' => Yii::t('app', 'KNOWLEDGE_BASE_MODEL_SELECT_SOFTWARE_COMPONENT_FOR_GENERATE_OWL_CODE'),
        ]); ?>
    </div>
